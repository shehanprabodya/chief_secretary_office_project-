...
export default function RecipientTagInput({ organizations, recipients, onChange, readOnly = false }: RecipientTagInputProps) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      <div
        ...
        className={`flex min-h-[44px] flex-wrap items-center gap-2 rounded-lg border border-slate-300 px-3 py-2 focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-500/20 ${readOnly ? 'bg-slate-50' : 'cursor-text bg-white'}`}
      >
        {recipients.map((r) => (
          <span
            key={r.id}
