    ...
    <DashboardLayout pageTitle="Subject Management">
      ...
      <ConfirmDialog
        ...
        message={subjectToDelete
          ? `Delete ${subjectToDelete.code} — ${subjectToDelete.title}? This action cannot be undone.`
          : ''}
